...
echo ========================================================
echo   Building Timer Overlay (v1.1.12)
echo ========================================================
...
copy /y release\timer_overlay.exe release\TimerOverlay-v1.1.12.exe >nul
echo [SUCCESS] Built successfully: release\timer_overlay.exe (and release\TimerOverlay-v1.1.12.exe)
endlocal
