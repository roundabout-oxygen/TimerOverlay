...
echo ========================================================
echo   Building Timer Overlay (v1.1.9)
echo ========================================================
...
copy /y release\timer_overlay.exe release\TimerOverlay-v1.1.9.exe >nul
echo [SUCCESS] Built successfully: release\timer_overlay.exe (and release\TimerOverlay-v1.1.9.exe)
endlocal
